...
- *Marked count* - Number of marked images, shown at the start when one or more are marked (e.g., =[3 marked]=)
...
- *Image count* - Current position / number of displayed images (e.g., =23/156=); with a filter on, the filtered set (e.g., =3/12=)
